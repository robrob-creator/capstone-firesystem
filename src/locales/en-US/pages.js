export default {
  ...
  'pages.label.address': 'Address',
  'pages.label.contact': 'Contact No.',
  'pages.label.reidents': 'Residents',
  'pages.label.resident': 'Resident',
  'pages.label.numberOfResidents': 'Number Of residents',
